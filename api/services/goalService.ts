...
class GoalService {
  async createGoal(goal: Goal): Promise<Goal> {
    ...
    try {
      ...
      throw new Error('Failed to create goal: An unexpected error occurred.');
    }
  }
  ...
  async getGoals(): Promise<Goal[]> {
    ...
    try {
      ...
      throw new Error('Failed to fetch goals: An unexpected error occurred.');
    }
  }
  ...
  async updateGoal(goal: Goal, goalId: number): Promise<Goal> {
    ...
    try {
      ...
      throw new Error('Failed to update goal: An unexpected error occurred.');
    }
  }
  ...
  async deleteGoal(goalId: number): Promise<void> {
    ...
    try {
      ...
      throw new Error('Failed to delete goal: An unexpected error occurred.');
    }
  }
}
